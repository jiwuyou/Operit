...
6. Practical tip: download an existing skill, extract it directly, and ensure the directory contains SKILL.md`;
    ...
    const TOOLPKG_DEBUG_INSTALL_COMPONENT = "com.wuxianc.operit/com.ai.assistance.operit.core.tools.packTool.ToolPkgDebugInstallReceiver";
    const SANDBOX_SCRIPT_EXECUTION_ACTION = "com.wuxianc.operit.EXECUTE_JS";
    const SANDBOX_SCRIPT_EXECUTION_COMPONENT = "com.wuxianc.operit/com.ai.assistance.operit.core.tools.javascript.ScriptExecutionReceiver";
